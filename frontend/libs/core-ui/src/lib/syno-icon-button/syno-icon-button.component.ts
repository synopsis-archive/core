...
Usage Example:
  <syno-icon-button>
    <i-tabler name="settings" class="navbar-icon-scale text-synogray-550"/>
  </syno-icon-button>
 */
@Component({
...
export class SynoIconButtonComponent extends SynoBaseComponent {
  ...
  styles = {
    "default": "h-10 w-10 flex justify-center border-synogray-350 items-center hover:border-[1px] border-[1.4px] focused:border-[1px] hover:bg-synogray-300/50 backdrop-blur-lg bg-synogray-0 rounded-full",
  }
